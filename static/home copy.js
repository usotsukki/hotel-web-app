...
tline.to('.inh-text', { y: '0%', duration: 1 });
tline.to('.intro', { y: '-100%', duration: 1, })
tline.to('.slider', { y: '-100%', duration: 1, })
*/
...
function carouselBox() {
    ...
    BtnNext.addEventListener('click', () => {
        if (counter >= CarouselSlideImgs.length - 1) { return; }
...
function mobileRoomList() {
    ...
    nextRoom.addEventListener('click', () => {
        if (counter >= rooms.length - 1) { return; }
...
function homeBookingAnimation() {
    ...
    var roomsXMinus = headerWidth - roomsTxtWidth / 2 - roomsTxtWidth - convertRemToPixels(10);
    ...
    tl.fromTo(".home-logo-font h1", 10, { ease: Power1.easeInOut, letterSpacing: 0 }, { ease: Power1.easeInOut, letterSpacing: headerWidth * 1.4, opacity: 0 });

    tl.fromTo(".home-slideshow", 10, { ease: Power1.easeInOut, opacity: 1 }, { ease: Power1.easeInOut, opacity: 0 });
    ...
    //var exitBB = TweenMax.fromTo('.rooms-txt-block', 25, { y: blockDestinationY, x: -blockWidth - 50, ease: Power1.easeInOut, opacity: 0.5 }, { ease: Power1.easeInOut, opacity: 1, y: blockDestinationY, x: blockDestinationX });
    //var exitAA = TweenMax.fromTo('.home-rooms-img', 30, { y: roomsDestinationY, x: headerWidth, ease: Power1.easeInOut, opacity: 0.5 }, { ease: Power1.easeInOut, opacity: 1, y: roomsDestinationY, x: roomsDestinationX });
    var exitBB = TweenMax.fromTo('.rooms-txt-block', 50, { x: -headerWidth, ease: Power1.easeInOut, opacity: 0.5 }, { ease: Power1.easeInOut, opacity: 1, x: 0 });
    var exitAA = TweenMax.fromTo('.home-rooms-img', 50, { x: headerWidth, ease: Power1.easeInOut, opacity: 0.5 }, { ease: Power1.easeInOut, opacity: 1, x: 0 });
    var exitB = TweenMax.fromTo('#w25', 50, { x: headerWidth, opacity: 0.5, ease: Power1.easeInOut }, { ease: Power1.easeInOut, opacity: 1, x: 0 });
    var exitA = TweenMax.fromTo('#w50', 50, { x: -headerWidth, opacity: 0.5, ease: Power1.easeInOut }, { ease: Power1.easeInOut, opacity: 1, x: 0 });
