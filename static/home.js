...
function homeBookingAnimation() {
    ...
    gsap.to('.inh-text', { ease: 'power1.out', y: '0%', duration: 1, delay: 0.5 });
    gsap.to('.intro', { ease: 'power1.out', y: '-100%', duration: 1, delay: 1.5 });
    gsap.to('.intro-tail', { ease: 'power1.out', y: '-100%', duration: .5, delay: 2 });
    gsap.to('.primary-header', { ease: 'power1.in', opacity: 1, duration: .5, delay: 2.25 });
    ...
    tl.fromTo(".home-slideshow", 5, { ease: Power1.easeInOut, opacity: 1 }, { ease: Power1.easeInOut, opacity: 0 });
    ...
    var exitBB = gsap.fromTo('.rooms-txt-block', 50, { x: -headerWidth, ease: Power1.easeInOut, opacity: 0.5 }, { ease: Power1.easeInOut, opacity: 1, x: 0 });
    var exitAA = gsap.fromTo('.home-rooms-img', 50, { x: headerWidth, ease: Power1.easeInOut, opacity: 0.5 }, { ease: Power1.easeInOut, opacity: 1, x: 0 });
    var exitB = gsap.fromTo('#w25', 50, { x: headerWidth, opacity: 0.5, ease: Power1.easeInOut }, { ease: Power1.easeInOut, opacity: 1, x: 0 });
    var exitA = gsap.fromTo('#w50', 50, { x: -headerWidth, opacity: 0.5, ease: Power1.easeInOut }, { ease: Power1.easeInOut, opacity: 1, x: 0 });
